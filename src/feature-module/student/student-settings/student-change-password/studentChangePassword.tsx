...
import {
  ...
  clearStudentState,
} from "../../../../core/redux/studentSlice"; // <- use student slice
...
const StudentChangePassword = () => {
  ...
  const { loading, error, success } = useSelector(
    (state: any) => state.student // plural/singular as your combineReducers!
  );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error?.message || "Unexpected error updating password.");
    }
  };
